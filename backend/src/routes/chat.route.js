...
router.get("/token", protectRoute, getStreamToken)// this full route is /api/chat/token, and here we call the generateStreamToken. also we're protecting this route with the middleware.
